...
export async function GET() {
  try {
    ...
    const usersData = [
      ...
      { name: 'Directrice Maternelle', email: 'dir.maternelle@lumiere.cd', phone: '+243810000012', role: 'DIRECTION' },
      { name: 'Directeur Primaire', email: 'dir.primaire@lumiere.cd', phone: '+243810000013', role: 'DIRECTION' },
      { name: 'Directeur Secondaire', email: 'dir.secondaire@lumiere.cd', phone: '+243810000014', role: 'DIRECTION' },
      { name: 'Discipline Maternelle', email: 'disc.maternelle@lumiere.cd', phone: '+243810000015', role: 'DISCIPLINE' },
      { name: 'Discipline Primaire', email: 'disc.primaire@lumiere.cd', phone: '+243810000016', role: 'DISCIPLINE' },
      { name: 'Discipline Secondaire', email: 'disc.secondaire@lumiere.cd', phone: '+243810000017', role: 'DISCIPLINE' },
