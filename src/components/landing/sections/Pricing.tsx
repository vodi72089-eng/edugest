...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      { text: '1 admin', included: true },
      { text: '5 professeurs', included: true },
      { text: '500 msg WhatsApp/mois', included: true },
      { text: 'Devoirs & discipline', included: true },
    ],
    cta: 'Commencer',
    ctaVariant: 'secondary',
    highlighted: false,
  },
  {
    ...
    features: [
      ...
      { text: '50 professeurs', included: true },
      { text: '1 500 msg WhatsApp/mois', included: true },
      { text: 'Paiements mobiles', included: true },
      { text: 'Bulletins officiels', included: true },
    ],
    cta: 'Commencer',
    ctaVariant: 'primary',
    highlighted: true,
  },
  {
    ...
    features: [
      ...
      { text: 'Module médical', included: true },
      { text: 'Support prioritaire', included: true },
      { text: 'Brand personnalisée', included: true },
    ],
    cta: 'Commencer',
    ctaVariant: 'secondary',
    highlighted: false,
