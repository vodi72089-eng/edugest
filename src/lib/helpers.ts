...
export const API_ROLE_MAP: Record<string, UserRole> = {
  ...
  // Rôle legacy ( Freemium ) : rétabli en SCHOOL_ADMIN côté front — le serveur
  // applique toujours les permissions réelles du rôle ADMIN_FREEMIUM.
  ADMIN_FREEMIUM: 'SCHOOL_ADMIN',
  SECRETARY: 'SECRETARY',
  CASHIER: 'CASHIER',
