export const ACCENT = 'oklch(55% 0.15 175)'
export const ACCENT2 = 'oklch(45% 0.13 200)'
export const ACCENT_SOFT = 'oklch(95% 0.04 175)'
export const SUCCESS = 'oklch(60% 0.15 145)'
export const WARNING = 'oklch(72% 0.15 65)'
export const DANGER = 'oklch(58% 0.20 25)'
export const INFO = 'oklch(60% 0.13 250)'
export const MUTED = 'oklch(52% 0.015 250)'
export const BORDER = 'oklch(92% 0.005 250)'

// LUXE AFRICAIN Design Tokens
export const GOLD = 'oklch(72% 0.15 65)'
export const GOLD_SOFT = 'oklch(95% 0.05 65)'
export const GOLD_GLOW = 'oklch(72% 0.15 65 / 0.35)'
export const DARK = 'oklch(15% 0.02 250)'
export const DARK_ALT = 'oklch(20% 0.03 175)'
export const IVORY = 'oklch(97% 0.005 175)'
export const IVORY_WARM = 'oklch(96% 0.008 175)'
export const TEXT_PRIMARY = 'oklch(15% 0.02 250)'
export const TEXT_MUTED_LUXE = 'oklch(45% 0.02 250)'
export const SUCCESS_SOFT = 'oklch(95% 0.04 145)'

export const SUBSCRIPTION_TIERS = ['PREMIUM', 'STANDARD', 'ESSENTIEL', 'ENTERPRISE', 'FREEMIUM', 'CORPORATE']
