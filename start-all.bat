...
echo   [1] WhatsApp Server (port 3001) - ouvert

start "Next.js - Port 3000" cmd /k "cd /d %~dp0 && npm run dev"
echo   [2] Next.js (port 3000) - ouvert

echo.
echo   2 fenetres ouvertes.
echo   Patientez 5 secondes puis ouvrez :
echo.
