...
This archive is the source of truth for turning the design into production code. Start from `01-public-home.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `01-public-home.html`
...
- A single self-contained `01-public-home.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `01-public-home.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `01-public-home.html`
- `02-school-public.html`
- `03-login.html`
- `04-super-admin-dashboard.html`
- `05-super-admin-schools.html`
- `06-secretary-dashboard.html`
- `07-secretary-students.html`
- `08-teacher-grades.html`
- `09-cashier-dashboard.html`
- `10-cashier-payment.html`
- `11-parent-dashboard.html`
- `12-parent-bulletin.html`
- `13-discipline-blacklist.html`
- `14-pricing.html`
- `15-grade-transition.html`
- `16-communications.html`
- `17-convocation.html`
- `18-profile.html`
- `19-teacher-homework.html`
- `20-teacher-class.html`
...
1. Inspect `01-public-home.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
